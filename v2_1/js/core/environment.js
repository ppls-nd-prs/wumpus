...
var Environment = function(i, j, width, height, n_wumpusses, n_pits) {
	...
	this.randomInitialization = function(){
        ...
        this.level = RandomUtils.getRandomLevel(this.i, this.j, this.n_wumpusses, this.n_pits);
